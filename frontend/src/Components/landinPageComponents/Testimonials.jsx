...
const Testimonials = ({ testFrom }) => {
    ...
    return (
        <section id='testimonials' className="text-gray-600 body-font py-20 lg:px-20">
            ...
            <div className="container py-24 mx-auto overflow-hidden">
                <div className="flex justify-around gap-10 overflow-x-scroll scrollbar-hide" ref={testimonialsRef}>

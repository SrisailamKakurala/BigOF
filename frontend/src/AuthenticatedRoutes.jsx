...
//       <Routes>
//         <Route path='/' element={<FarmerDashBoard setIsAuthenticated={setIsAuthenticated} />} />
//         <Route path='/buyerDashboard' element={<BuyerDashBoard setIsAuthenticated={setIsAuthenticated} />} />

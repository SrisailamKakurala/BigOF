    ...
    <div>
      ...
      <section className="text-gray-600 body-font -mt-5">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <h1 className="sm:text-3xl text-3xl font-medium title-font text-gray-900">Features</h1>
          </div>
      ...
      <section className="text-gray-600 body-font -mt-20">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h2 className="text-xs text-green-500 tracking-widest font-medium title-font mb-1">BIGOF</h2>
            <h1 className="sm:text-3xl text-3xl font-medium title-font text-gray-900">Benefits</h1>
          </div>
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/3">
              <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
